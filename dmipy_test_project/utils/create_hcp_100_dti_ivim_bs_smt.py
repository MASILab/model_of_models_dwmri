...
def main():
    ...
    base_json_path = r'/nfs/masi/nathv/miccai_2020_hcp_100_jsonfiles'
    base_json_path = os.path.normpath(base_json_path)

    methods_List = ['IVIM', 'MC_SMT', 'BS_2003', 'DTI']
    ...
    json_path = os.path.join(base_json_path, json_f_name)
    ...
    new_data_dict = {}
    new_data_dict['train'] = json_dump[0:40]
    new_data_dict['validation'] = json_dump[40:64]
    new_data_dict['test'] = json_dump[64:89]
