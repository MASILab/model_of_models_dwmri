...
def main():
    # Ground Truth Paths
    json_path = r'/nfs/masi/nathv/miccai_2020_hcp_100/data_list_hcp_100_ivim_dti.json'
    ...
    base_pred_path = r'/nfs/masi/nathv/miccai_2020_hcp_100_experiments/double_bottleneck_just_dti_test/bn_50/predicted_volumes/145127'
