...
def main():
    # Ground Truth Paths
    json_path = r'/nfs/masi/nathv/miccai_2020_hcp_100_jsonfiles/data_list_hcp_100_ivim_dti.json'
    ...
    base_pred_path = r'/nfs/masi/nathv/miccai_2020_hcp_100_experiments/double_bottleneck_just_mcsmt_mae_test/bn_50/predicted_volumes/211215'
