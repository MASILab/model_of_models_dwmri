...
from models.bottleneck_patch_models import build_just_ivim_double_bottleneck
from data_generators.data_generator_microstructure_patch import nifti_just_ivim_generator
from data_generators.test_data_generator_microstructure_patch import test_just_ivim_predictor
...
def main():
    ...
    parser.add_argument('--model_dir', '-m', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020_hcp_100_experiments/double_bottleneck_just_ivim',
                        help='model output directory')

    parser.add_argument('--save_dir', '-s', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020_hcp_100_experiments/double_bottleneck_just_ivim_test',
    ...
    for each_bnval in bottleneck_values:
        ...
        bottleneck_model = build_just_ivim_double_bottleneck(each_bnval)
        ...
        # Data Generators
        trainGen = nifti_just_ivim_generator(tr_data, bs=1000, patch_size=patch_crop)
        validGen = nifti_just_ivim_generator(val_data, bs=1000, patch_size=patch_crop)
        ...
        test_just_ivim_predictor(bottleneck_model, test_data, bn_save_path)
