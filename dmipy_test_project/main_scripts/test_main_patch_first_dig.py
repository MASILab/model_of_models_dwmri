...
def main():
    ...
    parser.add_argument('--save_dir', '-s', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020/first_shindig_predictions/118225',
                        help='Data List file for training stored in a JSON format')
    ...
    parser.add_argument('--prior_weights', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020/bottleneck_first_exp/weights-improvement-10-0.85.hdf5',
                        help='Yet to be defined')
    ...
    if args.script_mode == "test":
        test_patch_predictor(bottleneck_model, tr_data, args.save_dir)
    return None
