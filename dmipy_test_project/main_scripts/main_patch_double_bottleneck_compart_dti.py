...
def main():
    ...
    parser.add_argument('--model_dir', '-m', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020/double_bottleneck_compart_dti',
                        help='model output directory')

    parser.add_argument('--save_dir', '-s', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020/double_bottleneck_compart_dti_test',
    ...
    for each_bnval in bottleneck_values:
        ...
        bottleneck_model = build_patch_double_bottleneck(each_bnval)
