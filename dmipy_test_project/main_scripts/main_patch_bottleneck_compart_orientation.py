...
from data_generators.data_generator_microstructure_patch import nifti_compart_orient_generator
...
def main():
    ...
    parser.add_argument('--model_dir', '-m', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020/bottleneck_compart_orient',
    ...
    for each_bnval in bottleneck_values:
        ...
        # Data Generators
        trainGen = nifti_compart_orient_generator(tr_data, bs=1000, patch_size=patch_crop)
        validGen = nifti_compart_orient_generator(val_data, bs=1000, patch_size=patch_crop)
