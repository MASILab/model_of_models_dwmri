...
from data_generators.test_data_generator_microstructure_patch import test_patch_predictor
...
def main():
    ...
    parser.add_argument('--data_list', '-d', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020/micro_methods_hcp_mini/data_list_cd.json',
                        help='Data List file for training stored in a JSON format')

    parser.add_argument('--save_dir', '-s', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020/first_shindig_predictions/CD_1',
                        help='Data List file for training stored in a JSON format')

    parser.add_argument('--model_dir', '-m', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020/bottleneck_first_exp',
    ...
    parser.add_argument('--prior_weights', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020/bottleneck_multi_exp/bn_14/weights-improvement-37-0.68.hdf5',
                        help='Yet to be defined')
    ...
    bottleneck_model = build_sh_patch_resnet_bottleneck(50)
    patch_crop = [3, 3, 3]
    ...
    if args.script_mode == "test":
        test_patch_predictor(bottleneck_model, test_data, args.save_dir)
    return None
