...
from models.bottleneck_patch_models import build_dti_ivim_double_bottleneck
from data_generators.data_generator_microstructure_patch import nifti_dti_ivim_generator
from data_generators.test_data_generator_microstructure_patch import test_dti_ivim_predictor
...
def main():
    ...
    parser.add_argument('--data_list', '-d', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020_hcp_100/data_list_hcp_100_ivim_dti.json',
                        help='Data List file for training stored in a JSON format')

    parser.add_argument('--model_dir', '-m', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020_hcp_100_experiments/double_bottleneck_dti_ivim',
                        help='model output directory')

    parser.add_argument('--save_dir', '-s', required=False, type=str,
                        default=r'/nfs/masi/nathv/miccai_2020_hcp_100_experiments/double_bottleneck_dti_ivim_test',
    ...
    #
    bottleneck_values = [1, 2, 3, 4, 5, 6, 7, 8, 10, 15, 20, 30, 40, 50]
    ...
    for each_bnval in bottleneck_values:
        ...
        bottleneck_model = build_dti_ivim_double_bottleneck(each_bnval)
        ...
        # Data Generators
        trainGen = nifti_dti_ivim_generator(tr_data, bs=1000, patch_size=patch_crop)
        validGen = nifti_dti_ivim_generator(val_data, bs=1000, patch_size=patch_crop)
        ...
        test_dti_ivim_predictor(bottleneck_model, test_data, bn_save_path)
