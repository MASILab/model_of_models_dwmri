...
def main():
    ...
    for each_pkl_f in pkl_f_list:
        ...
        rand_nodel_act_iter_3_test.append(data_dict['svgd_rand_nodel'][act_iter_3_name]['max_test_dice'])
        rand_nodel_act_iter_11_test.append(data_dict['svgd_rand_nodel'][act_iter_11_name]['max_test_dice'])
        rand_nodel_act_iter_15_test.append(data_dict['svgd_rand_nodel'][act_iter_15_name]['max_test_dice'])
